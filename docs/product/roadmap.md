...
## B. Sharpen the queue — **shipped and verified end to end; `R-B35`–`R-B37`'s verdicts landed 2026-08-03, after R-B27–29 and R-B31–34 on 2026-07-30. `R-B39`, `R-B40` and `R-B41` are the rows still awaiting one**
...
## F. Cross-session intelligence — **shipped and verified 2026-07-30 (feature [0017](../features/0017-cross-session.md)); reopened 2026-08-03 by `R-F13`, which puts `R-F1`'s corpus in front of you rather than waiting to be asked**
...
| R-L2 | **Notes and documents** — markdown documents you write, owned by the daemon and mirrored to `~/.mogeung/notes/*.md` one way, edited in the window. The scratchpad half, and never the worktree's files. **Gated on `R-B35`**: if notes are not written where they have an obvious home, they will not be written in a pane either ([A27](assumptions.md)). See [feature 0026](../features/0026-notes-and-tasks.md) | L | |
