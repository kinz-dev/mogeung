...
`R-B43`–`R-B49` were built on 2026-08-06 and await a verdict; `R-B50` is not
started. They are one thread rather than a scattering:
...
every session at once, and is held back on purpose until `R-B49` has been
lived with — see [A30](assumptions.md).
