...
**The pillar is open again, and the window's shape is what reopened it.**
`R-B43`–`R-B49` were built on 2026-08-06 and await a verdict, and `R-B38` and
`R-B50` joined them on 2026-08-07. They are one thread rather than a
scattering:
